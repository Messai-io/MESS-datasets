# Table_1_Shear Stress Affects Biofilm Structure and Consequently Current Generation of Bioanode in Microbial Electrochemical Systems (MESs).docx

- **Source**: Figshare
- **Article ID**: `7808354`
- **Supplementary DOI**: [10.3389/fmicb.2019.00398.s001](https://doi.org/10.3389/fmicb.2019.00398.s001)
- **Paper DOI**: [10.3389/fmicb.2019.00398](https://doi.org/10.3389/fmicb.2019.00398)
- **Publication date**: 2019-03-06
- **License (upstream)**: CC BY 4.0
- **Authors**: Jiawei Yang, Shaoan Cheng, Chaochao Li, Yi Sun, Haobin Huang
- **Keywords**: anode biofilm, shear stress, anode performance, viability, microbial community
- **Fetched**: 2026-04-20T05:33:20+00:00

## Files

| Name | Size (bytes) | Committed | Local path |
| --- | --- | --- | --- |
| `Table_1_Shear Stress Affects Biofilm Structure and Consequently Current Generation of Bioanode in Microbial Electrochemical Systems (MESs).docx` | 405799 | yes | `files/Table_1_Shear Stress Affects Biofilm Structure and Consequently Current Generation of Bioanode in Microbial Electrochemical Systems (MESs).docx` |
