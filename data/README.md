...
One subdirectory per dataset source or topic. Each subdirectory must contain a
`DATASHEET.md` before any data files land, covering:
...
- **Slug join keys** — which MESS-Parameters / MESS-Materials slugs (if any) the
  dataset references.
